...
public final class CoreServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.spring.grpc.core.schema.PingRequest,
      com.demo.spring.grpc.core.schema.PingResponse> getPingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Ping",
      requestType = com.demo.spring.grpc.core.schema.PingRequest.class,
      responseType = com.demo.spring.grpc.core.schema.PingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.spring.grpc.core.schema.PingRequest,
      com.demo.spring.grpc.core.schema.PingResponse> getPingMethod() {
    io.grpc.MethodDescriptor<com.demo.spring.grpc.core.schema.PingRequest, com.demo.spring.grpc.core.schema.PingResponse> getPingMethod;
      ...
      synchronized (CoreServiceGrpc.class) {
        if ((getPingMethod = CoreServiceGrpc.getPingMethod) == null) {
          CoreServiceGrpc.getPingMethod = getPingMethod = 
              io.grpc.MethodDescriptor.<com.demo.spring.grpc.core.schema.PingRequest, com.demo.spring.grpc.core.schema.PingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "sms.core.CoreService", "Ping"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.spring.grpc.core.schema.PingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.spring.grpc.core.schema.PingResponse.getDefaultInstance()))
  ...
  public static abstract class CoreServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void ping(com.demo.spring.grpc.core.schema.PingRequest request,
        io.grpc.stub.StreamObserver<com.demo.spring.grpc.core.schema.PingResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.demo.spring.grpc.core.schema.PingRequest,
                com.demo.spring.grpc.core.schema.PingResponse>(
                  this, METHODID_PING)))
          .build();
    }
  }
  ...
  public static final class CoreServiceBlockingStub extends io.grpc.stub.AbstractStub<CoreServiceBlockingStub> {
    ...
    /**
     */
    public com.demo.spring.grpc.core.schema.PingResponse ping(com.demo.spring.grpc.core.schema.PingRequest request) {
  ...
  public static final class CoreServiceFutureStub extends io.grpc.stub.AbstractStub<CoreServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.spring.grpc.core.schema.PingResponse> ping(
        com.demo.spring.grpc.core.schema.PingRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PING:
          serviceImpl.ping((com.demo.spring.grpc.core.schema.PingRequest) request,
              (io.grpc.stub.StreamObserver<com.demo.spring.grpc.core.schema.PingResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CoreServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demo.spring.grpc.core.schema.CoreGrpcApi.getDescriptor();
    }
